        ...
        <div className='body'>
            ...
            <h4 className="profile">Admin</h4>
               <form>
                    ...
                    <div className="button-container">
                        <input className="input" type="text" placeholder="Enter mentor's email address" name="email"/>  
                        <button className = "reset-button">Reset</button>
                    </div>
                    <label className="reset-password"><b>Add New Tutor</b></label>
                    <div className="button-container">
                        <input className="input" type="text" placeholder="Enter tutor's email address" name="email"/>
                        <button className = "reset-button">Reset</button>
                    </div>
                    <label className="reset-password"><b>Add New Administrator</b></label>
                    <div className="button-container">
                        <input className="input" type="text" placeholder="Enter administrator's email address" name="email"/>
                        <button className = "reset-button">Reset</button>
                    </div>
               </form> 
            </div>
